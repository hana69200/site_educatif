<?php
	...
	$query = $bdd->prepare("select francais from salle3"); // requête SQL
	...
	$bdd = connectDb(); //connexion à la BDD
	$query = $bdd->prepare("select geo from salle3"); // requête SQL
	$query->execute(); // paramètres et exécution
	...
	$bdd = connectDb(); //connexion à la BDD
	$query = $bdd->prepare("select histoire from salle3"); // requête SQL
	$query->execute(); // paramètres et exécution
	...
	$bdd = connectDb(); //connexion à la BDD
	$query = $bdd->prepare("select anglais from salle3"); // requête SQL
	$query->execute(); // paramètres et exécution
	...
	$bdd = connectDb(); //connexion à la BDD
	$query = $bdd->prepare("select maths from salle3"); // requête SQL
	$query->execute(); // paramètres et exécution
